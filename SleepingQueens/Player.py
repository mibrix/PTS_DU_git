...
#test pre pripad ked hra jednu kartu
# state = PlayerState({1:Card(CardType(1),5)},{})
# pile = DrawingAndTrashPile([Card(CardType(1),6),Card(CardType(1),4)], [])
# a = Player(1,state,pile,Hand(1,state.cards,pile))
# print(a.playerState.cards)
# print(a.playerState.cards[1].value == 5) #=5
#
# a.play([HandPosition(1,1)])
# print(a.playerState.cards[1].value == 6) #=6

#test ked chce iba vyhodit dve karty
# state = PlayerState({1:Card(CardType(1),5),2:Card(CardType(1),5)},{})
# pile = DrawingAndTrashPile([Card(CardType(1),6),Card(CardType(1),4)], [])
# a = Player(1,state,pile,Hand(1,state.cards,pile))
# print(a.playerState.cards)
# print(a.playerState.cards[1].value == 5) #=5
#
# a.play([HandPosition(1,1), HandPosition(2,1)])
# print([i.value for i in a.playerState.cards.values()]  == [6,4]) #=6

#test ked chce vyhodit tri karty
# state = PlayerState({1:Card(CardType(1),5),2:Card(CardType(1),3),3:Card(CardType(1),2)},{})
# pile = DrawingAndTrashPile([Card(CardType(1),6),Card(CardType(1),4),Card(CardType(1),4)], [])
# a = Player(1,state,pile,Hand(1,state.cards,pile))
# print(a.playerState.cards)
# print(a.playerState.cards[1].value == 5) #=5
#
# a.play([HandPosition(1,1), HandPosition(2,1), HandPosition(3,1)])
# print([i.value for i in a.playerState.cards.values()]  == [6,4,4]) #=6

#test pre utok na kralovnu knightom

# state = PlayerState({1:Card(CardType(3),5),2:Card(CardType(1),5)},{})
# pile = DrawingAndTrashPile([Card(CardType(1),6),Card(CardType(1),4)], [])
# a = Player(1,state,pile,Hand(1,state.cards,pile))
#
# state1 = PlayerState({1:Card(CardType(3),5),2:Card(CardType(1),5)},{})
# b = Player(2,state1,pile,Hand(2,state1.cards,pile))
# kralovna = Queen(1)
# b.awokenQueens.addQueen(kralovna)
#
# a.currentTargetOpponentHand = b.hand
# a.currentTargetOpponentQueens = b.awokenQueens
#
# print(b.awokenQueens.getQueens())
# a.play([HandPosition(1,1), AwokenQueenPosition(1,2)])
# print(a.playerState.awokenQueens)
# print(a.awokenQueens.getQueens())
# print(b.awokenQueens.getQueens())

#test pre utok na kralovnu potionom

# state = PlayerState({1:Card(CardType(4),5),2:Card(CardType(1),5)},{})
# pile = DrawingAndTrashPile([Card(CardType(1),6),Card(CardType(1),4)], [])
# a = Player(1,state,pile,Hand(1,state.cards,pile))
#
# state1 = PlayerState({1:Card(CardType(6),5),2:Card(CardType(1),5)},{})
# b = Player(2,state1,pile,Hand(2,state1.cards,pile))
# kralovna = Queen(1)
# b.awokenQueens.addQueen(kralovna)
#
# a.currentTargetOpponentHand = b.hand
# a.currentTargetOpponentQueens = b.awokenQueens
# a.currentlySleepingQueens = SleepingQueens({})
#
# print(a.currentlySleepingQueens.getQueens())
# a.play([HandPosition(1,1), AwokenQueenPosition(1,2)])
# print(a.currentlySleepingQueens.getQueens())

#test pre zobudenie kralovnej

# state = PlayerState({1:Card(CardType(2),5),2:Card(CardType(1),5)},{})
# pile = DrawingAndTrashPile([Card(CardType(1),6),Card(CardType(1),4)], [])
# a = Player(1,state,pile,Hand(1,state.cards,pile))
# a.currentlySleepingQueens = SleepingQueens({SleepingQueenPosition(1):Queen(1)})
#
# print(a.currentlySleepingQueens.getQueens())
# print(a.awokenQueens.getQueens())
# a.play([HandPosition(1,1),SleepingQueenPosition(1)])
# print(a.currentlySleepingQueens.getQueens())
# print(a.awokenQueens.getQueens())
